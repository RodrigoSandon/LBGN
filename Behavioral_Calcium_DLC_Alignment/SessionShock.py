...
class Neuron(Session):
    ...
    def add_aligned_dff_traces(
        ...
        **groupby_dict
        ...
        # IN THE CASE OF SHOCK, ONLY ONE COMBINATION


class EventTrace(Neuron):  # for one combo
    # 1/3/22 BUT IN THE CASE OF SHOCK, WE WANT TO BIN THIS COMBO IN A CUSTOMIZED FASHION
    # BASED ON HOW MANY BINS YOU WANT, # OF OCCURENCES FOR EACH BIN WILL CHANGE (SUBCOMBO #)
    """
